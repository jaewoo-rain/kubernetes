...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "jaewoo-node" do |master|
    master.vm.hostname = "k8s-jaewoo"
...
kubectl taint nodes k8s-jaewoo node-role.kubernetes.io/control-plane-
